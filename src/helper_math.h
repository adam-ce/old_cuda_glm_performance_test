...
inline __host__ mat4 make_mat4(glm::mat4 m) {
    mat4 n;
    m = glm::transpose(m);
    n.r0 = make_float4(m[0]);
    n.r1 = make_float4(m[1]);
    n.r2 = make_float4(m[2]);
    n.r3 = make_float4(m[3]);
    return n;
}
